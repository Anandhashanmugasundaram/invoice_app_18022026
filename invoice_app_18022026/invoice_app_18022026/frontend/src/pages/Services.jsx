...
export default function Services() {
  ...
  const services = [
    ...
    {
      title: "AI-Powered  Audited Balance Sheet",
      description:
        "Analyze balance sheets with AI-driven insights, detect discrepancies, ensure compliance, and generatex financial audit reports",
      icon: <Percent size={40} />,
      action: () => navigate("/updates"),
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-900 to-purple-700 text-white">
      ...
      >
        ...
        <div className="relative z-10 px-6 max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
           <span className="text-yellow-400">JET</span> SERVICES
          </h1>
